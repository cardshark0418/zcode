...
rem zcode launcher — put this directory on PATH, then type: zcode
...
java -Dfile.encoding=UTF-8 -Dstdin.encoding=UTF-8 -Dstdout.encoding=UTF-8 -Dstderr.encoding=UTF-8 -Dsun.stdout.encoding=UTF-8 -Dsun.stderr.encoding=UTF-8 -Dconsole.encoding=UTF-8 %ZCODE_CHAR_DELAY_OPT% -jar "%JAR%" %*
exit /b %ERRORLEVEL%
